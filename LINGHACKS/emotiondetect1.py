...
neg=['horrible','really bad','not really','sad', 'depressed','not good','suicidal','never','no','nah','No','Nah','bad','pretty bad','I do not know']
ed=0
if smilecount < 100:
    q1='We have detected that you are feeling sad, Could we survey you?'
    ...
    if ed==1:
        ...
        time.sleep(4)
        q7='Looks like your having a good day'
        vq7=gtts.gTTS(text=q7)
        vq7.save("q7.mp3")
        playsound.playsound("q7.mp3")
        print(q7)
    elif ed==-1:
        print('Processing your emotion...')
        time.sleep(4)
        q8='Hmm seems like you are having a bad day. Having a more positive outlook might help you'
        vq8=gtts.gTTS(text=q8)
        vq8.save("q8.mp3")
        playsound.playsound("q8.mp3")
        print(q8)
    elif ed==2:
        print('Processing your emotion...')
        time.sleep(4)
        q10='You seem like you are generally a happy person'
        vq10=gtts.gTTS(text=q10)
        vq10.save("q10.mp3")
        playsound.playsound("q10.mp3")
        print(q10)
    elif ed== -2:
        print('Processing your emotion...')
        time.sleep(4)
        q9='You seem sad. You should maybe talk to a loved one about our emotions.'
        vq9=gtts.gTTS(text=q9)
        vq9.save("q9.mp3")
        playsound.playsound("q9.mp3")
        print(q9)
    elif ed==3:
        print('Processing your emotion...')
        time.sleep(4)
        q11='Wow... your happiness made my day. Keep it up'
        vq11=gtts.gTTS(text=q11)
        vq11.save("q11.mp3")
        playsound.playsound("q11.mp3")
        print(q11)
    elif ed== -3:
        print('Processing your emotion...')
        time.sleep(4)
        q12='You might have chronic depression. Try to schedule an appointment with your counselor.'
        vq12=gtts.gTTS(text=q12)
        vq12.save("q12.mp3")
        playsound.playsound("q12.mp3")
        print(q12)
else:
